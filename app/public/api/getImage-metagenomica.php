<?php
	...
	while ($row = mysql_fetch_assoc($result)) {
		...
		$img = "<a class='example-image-link' href='admin/api/$ImagePath' data-lightbox='example-set'><img class='example-image w-[50%] ml-[25%]' src='admin/api/$ImagePath' alt='Metagenomica'/></a>";
		$Titulo = $row['Titulo'];	
	}		
