<header id="header-principal" class="md:h-[70px] 3xl:h-[100px] py-2 ">
    <div class="container">
        <nav id="navbar" class="fixed md:h-[70px] 3xl:h-[100px] top-0 z-40 flex w-full flex-row justify-end sm:justify-between items-center bg-[#6A88B4]">
            ...
            <div>
                <a href="index.php" >
                    <img src="assets/img/puyehue/logo-puyehue.svg" alt="Logo Puyehue" class="h-[60px]"/>
                </a>
            </div>
            <div>
                <img src="assets/img/puyehue/logo-impulsa.svg" alt="Logo Impulsa" class="h-[70px]">
            </div>
                ...
                <div class="container mx-auto py-16">
                    <div class="flex flex-col">
                        <ul>
                            ...
                            <li class="inline-block">
                                <a class="flex items-center font-blogger text-white font-medium md:text-[16px] 3xl:text-[20px]  md:leading-[22px] 3xl:leading-[26px] border-[1px] border-white rounded-[25px] pb-1 pt-2 px-8 md:mb-2 3xl:mb-4 hover:bg-amarillo hover:border-amarillo" href="lago-puyehue.php">
                                    LAGO PUYEHUE
                                </a>
                            </li><br>
                            <li class="inline-block">
