					...
					<div class="row">
						<div class="col-md-12">
							...
							<table id="bootstrap-table" class="table">
								...
								<tbody>
								<?php
									$sql="SELECT * FROM puntos_mediciones_lp ORDER BY ID ASC";
									...
									while ($row = mysql_fetch_assoc($result)) {
										echo "<tr>
													...
													<td>{$row['ID']}</td>
													<td>{$row['Nombre']}</td>
													<td><a href='index.php?userid=$userid&section=lagopuyehue-mediciones&puntoid={$row['ID']}'><i class='fa fa-info-circle text-warning' style='font-size:25px'></i></a></td>
												</tr>";
									}
								?>
								</tbody>
