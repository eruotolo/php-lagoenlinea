            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card ">
                            <div class="header">
                                <h4 class="title <?php echo $title_color ?>">Lago sin huella: Biblioteca</h4>
                            </div>
                            <div class="content">
                                <div class="row">
                                    <div class="col-md-12">
										<div id="toolbar" class="btn-group pull-right" style='margin-top:15px'>
											<a style='margin-right:5px' rel="tooltip" title="Crear nuevo" type="button" class="btn btn-warning btn-fill noblock btn-social btn-round" href='index.php?userid=<?php echo $userid ?>&section=lagosinhuella-biblioteca-add'>
        ...
        $().ready(function(){
            window.operateEvents = {
                'click .view': function (e, value, row, index) {
					window.location.href = "index.php?userid=<?php echo $userid ?>&section=lagosinhuella-biblioteca-add&cat=y&id=" + row.id;
                },
                'click .edit': function (e, value, row, index) {
                    window.location.href = "index.php?userid=<?php echo $userid ?>&section=lagosinhuella-biblioteca-edit&id=" + row.id;
                },
                'click .remove': function (e, value, row, index) {
					swal({
					  ...
					  if (result.value) {
						...
						$.ajax({
						type: "POST",
						url: "jquery/delete-lagosinhuellabiblioteca.php",
						data: {id: row.id},
						cache: false,
