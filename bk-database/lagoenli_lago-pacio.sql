...
--
-- Servidor: mysql
-- Tiempo de generación: 05-02-2025 a las 04:00:28
...
CREATE TABLE `documentos-complementarios` (
  `ID` int(11) NOT NULL,
  `Decripcion` text CHARACTER SET latin1,
  `Titulo` varchar(300) CHARACTER SET latin1 DEFAULT NULL,
  `ImagenDestacada` varchar(300) CHARACTER SET latin1 DEFAULT NULL,
  `Autores` varchar(300) CHARACTER SET latin1 DEFAULT NULL,
  `FechaPublicacion` date DEFAULT NULL,
  `CampoLink` varchar(400) CHARACTER SET latin1 DEFAULT NULL,
  `ArchivoDescargar` varchar(400) CHARACTER SET latin1 DEFAULT NULL,
  `TipoRecurso` varchar(300) CHARACTER SET latin1 DEFAULT NULL
...
CREATE TABLE `filtros` (
  ...
  `Filtro` varchar(45) CHARACTER SET latin1 NOT NULL,
  `Valor` varchar(300) CHARACTER SET latin1 NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `incidentes` (
  ...
  `Lugar` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  ...
  `File1` varchar(400) CHARACTER SET latin1 DEFAULT NULL,
  `File2` varchar(400) CHARACTER SET latin1 DEFAULT NULL,
  `File3` varchar(400) CHARACTER SET latin1 DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `metagenomica` (
  ...
  `ImagePath` varchar(400) CHARACTER SET latin1 DEFAULT NULL,
  `Fecha` date DEFAULT NULL,
  `Titulo` varchar(300) CHARACTER SET latin1 DEFAULT NULL,
  `FilePath1` varchar(400) CHARACTER SET latin1 DEFAULT NULL,
  `FilePath2` varchar(400) CHARACTER SET latin1 DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `metagenomica-tablas` (
  ...
  `Year` int(11) DEFAULT NULL,
  `Cicle` int(11) DEFAULT NULL,
  `Tabla1` varchar(400) CHARACTER SET utf8mb4 DEFAULT NULL,
  `Tabla2` varchar(400) CHARACTER SET utf8mb4 DEFAULT NULL
...
--
-- Estructura de tabla para la tabla `puntos_mediciones_lp`
--

CREATE TABLE `puntos_mediciones_lp` (
  `ID` int(11) NOT NULL,
  `Nombre` varchar(100) CHARACTER SET latin1 DEFAULT NULL,
  `Lat` double DEFAULT NULL,
  `Lng` double DEFAULT NULL
...
--
-- Volcado de datos para la tabla `puntos_mediciones_lp`
--

INSERT INTO `puntos_mediciones_lp` (`ID`, `Nombre`, `Lat`, `Lng`) VALUES
(1, 'Entre Lagos', -40.67989, -72.59967),
(2, 'Nilque', -40.71015, -72.48458),
(3, 'Gol Gol', -40.66794, -72.33955),
(17, 'Mantilhue', -40.63522, -72.42934);
...
--
-- Estructura de tabla para la tabla `puntos_muestras_lp`
--

CREATE TABLE `puntos_muestras_lp` (
  `ID` int(11) NOT NULL,
  `Fecha` date DEFAULT NULL,
  `PuntoID` int(11) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `puntos_muestras_lp`
--

INSERT INTO `puntos_muestras_lp` (`ID`, `Fecha`, `PuntoID`, `oxigeno`, `temperatura`, `ph`, `conductividad`) VALUES
(388, '2025-02-01', 1, 566, 30, 12, 36),
(387, '2025-02-03', 1, 1002, 6, 7, 8),
(386, '2025-02-04', 1, 998, 3, 4, 5);
...
(-72.9736632, -41.3157964);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `ubicacion_lp`
--

CREATE TABLE `ubicacion_lp` (
  `Lng` double DEFAULT NULL,
  `Lat` double DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
(1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', '', '', NULL, '2025-02-04 21:48:36', 0, '', '', NULL, NULL, '', NULL, '', '', NULL, 1, 'Administrador', 0),
...
--
-- Indices de la tabla `puntos_mediciones_lp`
--
ALTER TABLE `puntos_mediciones_lp`
  ADD PRIMARY KEY (`ID`);
...
--
-- Indices de la tabla `puntos_muestras_lp`
--
ALTER TABLE `puntos_muestras_lp`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT de la tabla `puntos_mediciones_lp`
--
ALTER TABLE `puntos_mediciones_lp`
...
--
-- AUTO_INCREMENT de la tabla `puntos_muestras_lp`
--
ALTER TABLE `puntos_muestras_lp`
